"""
Complete Gmail Authentication - One Click Solution
Run this, open the URL it gives you, then paste the code back in the SAME terminal
"""
...
def main():
    print()
    print('=' * 70)
    print('  GMAIL AUTHENTICATION - balckcat699@gmail.com')
    print('=' * 70)
    print()
    ...
    auth_info = client_config.get('installed', client_config.get('web', {}))
    ...
    print(auth_url)
    print()
    print('STEP 2: Sign in with balckcat699@gmail.com')
    print('STEP 3: Click "Allow" to grant ALL permissions')
    print('STEP 4: Copy the authorization code (starts with 4/...)')
    print()
    
    # Get code from user
    code = input('STEP 5: Paste the authorization code here and press Enter: ').strip()
    ...
    if resp.status_code == 200:
        ...
        print('=' * 70)
        print()
        print(f'[OK] Token saved for: balckcat699@gmail.com')
        print()
        print('Scopes granted:')
        print('  ✓ gmail.readonly - Read emails')
        print('  ✓ gmail.send - Send emails')
        print()
        print('✅ Your AI Employee is now connected to balckcat699@gmail.com!')
        print()
        print('Next steps:')
        print('  1. Test Gmail Watcher:')
        ...
        print(resp.text)
        print()
        print('The code may have expired. Please run this script again.')
        return False
